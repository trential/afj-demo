...
export class Alice extends BaseAgent {
  ...
  public async acceptCredentialOffer(credentialRecord: CredentialExchangeRecord) {
    ...
    console.log(greenText(`Received credential with attributes ${JSON.stringify((await
      this.agent.credentials.findById(credentialRecord.id))?.credentialAttributes)}`))
  }
